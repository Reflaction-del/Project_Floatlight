...
const world = () => ({ entities: [], relations: [], outline: [], timelines: [], docs: [], folders: [], styles: [], materials: [], templates: [], drafts: [], activeDocId: '', activeTimelineId: '', clueBoard: {}, proposals: [], chats: [], simulations: [] }) as WorldData;
